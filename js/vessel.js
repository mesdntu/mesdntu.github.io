    ...
    if (vessel) {
        ...
        switch (vessel.compatible.toLowerCase()) {
            case "compatible with b100":
                ...
                // 当兼容 B100 时，隐藏 next_steps_section
                document.querySelector('.next_steps_section').style.display = 'none';
                break;
            ...
            case "conditionally compatible with bxx":
                ...
                // 显示 next_steps_section
                document.querySelector('.next_steps_section').style.display = 'flex';
                break;
        ...
        if (vessel.compatible.toLowerCase() === "conditionally compatible with b100") {
        ...
        // 更新 Dimensions 和 Engine Particulars 的内容
...
function generateBreadcrumb() {
    ...
    let breadcrumbHTML = '<a href="searchpage.html">Search Page</a>';

    // Path 1: Home > Searchpage > Prefix Collection > Vessel Profile
    if (prefix) {
        breadcrumbHTML += ` &gt; <a href="prefix.html?prefix=${encodeURIComponent(prefix)}">Prefix Collection</a>`;
        breadcrumbHTML += ` &gt; <a href="vessel.html?vessel=${encodeURIComponent(vessel)}&prefix=${encodeURIComponent(prefix)}">Vessel Profile</a>`;
    }
    // Path 2: Home > Searchpage > Owner Collection > Vessel Collection > Vessel Profile
    else if (owner) {
        breadcrumbHTML += ` &gt; <a href="owners.html">Owner Collection</a>`;
        breadcrumbHTML += ` &gt; <a href="owner_vessel.html?owner=${encodeURIComponent(owner)}">Vessel Collection</a>`;
        breadcrumbHTML += ` &gt; <a href="vessel.html?vessel=${encodeURIComponent(vessel)}&owner=${encodeURIComponent(owner)}">Vessel Profile</a>`;
    }
    // Path 3: Home > Searchpage > Vessel Collection > Vessel Profile
    else {
        breadcrumbHTML += ` &gt; <a href="owner_vessel.html">Vessel Collection</a>`;
        breadcrumbHTML += ` &gt; <a href="vessel.html?vessel=${encodeURIComponent(vessel)}">Vessel Profile</a>`;
    }
